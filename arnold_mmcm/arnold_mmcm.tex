...
\summary{
  \begin{enumerate}
    \item
      ...
      The 2-form is the \emph{symplectic structure}.
      In most cases, the manifold has $n$ momentum components
    ...
    \item
      ...
      with $\omega^2 = \sum_i dp_i \wedge dq_i = d(p_i dq_i)$.
    ...
    \item
      ...
      $I$ is equivalent to the jacobian matrix
      $$
      \mathbf J =
      \left(
        \begin{array}{ccc}
...
a subalgebra ofthe Lie algebra of hamiltonian functions.
